...
from util import get_data, y2indicator, error_rate, init_weight_bias
...
class Ann:
	...
	def fit(self, X, Y, learning_rate=1e-3, mu=0.99, decay=0.999, reg=1e-3, epochs=10, batch_sz=100, show_fig=False):
		K = len(set(Y))
